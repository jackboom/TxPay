...
//				loadingView.startAnimation(refreshingAnimation);
	...
	private void initView()
	{
		...
		refreshingView = (ProgressBar) refreshView.findViewById(R.id.refreshing_bar);
		Log.d(TAG, "pullView == null:" + (pullView == null));
		Log.d(TAG, "refreshingView == null:" + (refreshingView == null));
		refreshStateImageView = refreshView.findViewById(R.id.state_iv);
		// 初始化上拉布局
		pullUpView = loadmoreView.findViewById(R.id.pullup_icon);
		loadStateTextView = (TextView) loadmoreView
				.findViewById(R.id.loadstate_tv);
		loadingView = (ProgressBar)loadmoreView.findViewById(R.id.loading_bar);
